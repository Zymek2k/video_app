...
class CategoryTest extends KernelTestCase
{
    ...
    public $mockedCategoryTreeAdminList;
    public $mockedCategoryTreeAdminOptionList;
    ...
    public function testCategoryTreeFrontPage($string, $array, $id)
    {
        ...
        $this->mockedCategoryTreeFrontPage->slugger = new SlugifyFilterExtension;
    ...
    public function dataForCategoryTreeOptionList()
    {
        yield [
            [
